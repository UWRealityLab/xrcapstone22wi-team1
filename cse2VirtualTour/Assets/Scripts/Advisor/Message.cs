...
{
    public const string WELCOME_MESSAGE = "Welcome to the CSE advising center. I'm your advisor Anna. At Allen School, we have 17 people on the <b>Undergraduate Advising Team, Diversity & Access Team,</b> and <b>Administrative Support Team</b> to help you with all the information and resources.";
    ...
    // High School Student
    public const string HIGH_SCHOOL_INTRO = "Thank you for your interest in the Paul G. Allen School of Computer Science & Engineering. You will be considered for Direct To Major (DTM) admission in the Allen School if you select Computer Science or Computer Engineering as the first-choice major on your application.";

    public const string HS_Q_ADMIN_RATE = "What is the admission rate for the Allen School?";
    public const string HS_A_ADMIN_RATE = "In 2021,\n1732 WA residents applied and 456 were admitted (26.3%).\n3887 Domestic Non-Resident applied and 99 were admitted (2.5%).\n1117 international students applied and 43 were admitted (3.84%).";
    ...
    // Transfer Student
    public const string TRANSFER_INTRO = "Thank you for your interest in the Paul G. Allen School of Computer Science & Engineering. Admission to the Allen School is competitive. Transfer students who are admitted to the Allen School typically will have earned nearly perfect grades in their prerequisites courses, have strong grades overall and in their most recent 40 transferrable quarter credits.";

    public const string TF_Q_TIMELINE = "What is the key dates and deadlines for transfer application?";
    public const string TF_A_TIMELINE = "You will need to fill out the UW transfer application and Allen School supplemental application to complete the process. There are two cycles per year to apply for the transfer - Spring and Fall. For spring admissions, the deadline for UW transfer application is Dec 15th and Allen School supplemental application is Jan 15th. The decision will be sent in early February. For Fall admissions, the deadline for UW transfer application is Feb 15th and Allen School supplemental application is Apr 15th. The decision will be sent in mid May.";
    ...
    public const string TF_Q_REVIEW = "Can someone at the Allen School review my personal statement for the departmental application?";
    public const string TF_A_REVIEW = "No. The Allen School is unable to provide a personal statement review for transfer applicants seeking admission. For support in writing your personal statement, please use writing and transfer resources at your current institution.";
    ...
    public const string INTERACTIVE_WALL_TWO = "By the way, once you finished this section, please go to the advising center!";
